...
export const metadata: Metadata = {
  ...
  authors: [{ name: "XGirl" }],
  keywords:
    "Annonces érotiques France, accompagnatrices, Escortes, services érotiques, annonces adultes, X-Girl",
  openGraph: {
    type: "website",
    locale: "fr_FR",
    siteName: "XGirl",
  ...
  return (
    <html lang="fr">
      <head>
        ...
        <meta name="description" content="Découvrez les meilleures annonces érotiques en France avec XGirl. Explorez une large gamme de services érotiques et trouvez les meilleures escortes et accompagnatrices de luxe en France." />

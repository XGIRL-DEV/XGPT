    ...
    async function fetchData() {
      try {
        ...
        const sortedProfiles = profilesWithCoordinates.sort(
          (a, b) => new Date(b.tagtimestamp).getTime() - new Date(a.tagtimestamp).getTime()
        );
  ...
  return (
    <div className="text-gray-600 bg-black w-full overflow-x-hidden">
      <Head>
        ...
        <meta property="og:description" content="Trouvez les meilleures escort girls et masseuses érotiques en France. Consultez nos annonces et nos nouveautés." />
